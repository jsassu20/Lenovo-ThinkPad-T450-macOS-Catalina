...
sudo cp -R Kext/*.kext /Volumes/ESP/EFI/CLOVER/kexts/Other/
sudo cp -R Kext/*.kext /Volumes/ESP/EFI/CLOVER/kexts/System/
echo "Complete..."
...
echo "Complete..."
sudo cp -R ACPI/*.aml /Volumes/ESP/EFI/CLOVER/ACPI/patched/
echo "."
