...
| Lenovo ThinkPad T450 Ultrabook | macOS Mojave | 10.14.x | Clover UEFI Hotpatched Configuration | Hackintosh | 100% Functioning |
...
* In order to achieve full functionality, you will need to swap out the stock Intel WiFi & BT card with a natively supported AirPort Card.
