...
//            Notify (\_SB.PCI0.LPCB.PS2K, 0x0406)
            Notify (\_SB.PCI0.LPCB.PS2K, 0x10)      // For Use With APS2STP.kext
        }

        Method (_Q15, 0, NotSerialized)  // F5 Brightness Down
        {
//            Notify (\_SB.PCI0.LPCB.PS2K, 0x0405)
            Notify (\_SB.PCI0.LPCB.PS2K, 0x20)      // For Use With APS2STP.kext
        }
/*
        Method (_Q6A, 0, NotSerialized)  // F4 Microphone Mute - Siri (SysPrefs>Siri>Keyboard Shortcut)
        {
            Notify (\_SB.PCI0.LPCB.PS2K, 0x033E)
        }
        ...
        {
            Notify (\_SB.PCI0.LPCB.PS2K, 0x036A)
        }
    }
